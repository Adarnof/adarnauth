...
class CharacterAccessForm(forms.Form):
    id = forms.PositiveIntegerField(label="Character ID", required=True)
...
class CorpAccessForm(forms.Form):
    id = forms.PositiveIntegerField(label="Corp ID", required=True)
...
class AllianceAccessForm(forms.Form):
    id = forms.PositiveIntegerField(label="Alliance ID", required=True)
